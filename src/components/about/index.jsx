...
export default function AboutUs() {
  return (
    <>
      <section id="about" className="bg-cover bg-center pb-20" style={{
            backgroundImage: `linear-gradient(rgba(227, 234, 236, 0.785), rgba(227, 234, 236, 0.785)), url(${onlylogobg})`
        }}>
        <div className="text-center">
          <div>
            <h1 className="font-bold text-xl pt-20 pb-5 md:text-3xl">About Us</h1>
          </div>
          ...
          <div className="p-5 md:text-lg lg:text-2xl">
            ...
            <br/>
            <p>At Onyx, we specialize in creating custom websites and web applications that exceed client expectations. From the initial concept to the final launch, we prioritize communication and attention to detail, ensuring a seamless and enjoyable experience for everyone involved.</p> <br/>
