...
<div class="ps-3.5">
    ...
    <p class="text-slate-400 pt-28 pb-3 text-xl relative z-10 text-center font-medium leading-tight before:static before:w-3 before:h-3 before:bg-violet-700 before:inline-block before:rounded-full before:me-2.5">
        Projects
    </p>
