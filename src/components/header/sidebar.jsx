...
//     return (
//         <>
//         <div className={${sidebarToggle ? " hidden " : " block " } ease-in-out w-64 bg-violet-100 fixed h-full px-4 py-2}>
//       <div className="my-2 mb-4">
//         <h1 className="tetxt-2x text-black font-bold">Admin Dashboard</h1>
//       </div>
//         <hr />
//         <ul className="mt-3 text-black font-bold">
//           <li className="mb-2 rounded hover:shadow hover:bg-violet-700 hover:text-white py-2">
