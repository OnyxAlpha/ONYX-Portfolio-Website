          ...
          <div className="border-b-2 border-slate-900 flex justify-between mb-2">
            <div>
              <p className="text-sm font-semibold md:text-xl">
                Web Developer @ Moreton Bay Regional Council
              </p>
            </div>
           ...
           <div className="flex">
            ...
            <div className="p-4">
              <ul className="list-disc">
                ...
                <li className="mb-2 md:text-lg">
                  Created site maps and userflows
                </li>
      ...
      <div className="lg:flex lg:justify-center">
        <div className="bg-blue-100 mt-5 border-slate-900 rounded-lg p-3 lg:w-3/4">
          <div className="border-b-2 border-slate-900 flex justify-between mb-2">
            <div>
              <p className="text-sm font-semibold md:text-xl">
                Frontend Developer @ InfotechdotnetSystems
              </p>
            </div>
            <div>
          ...
          <div>
            ...
            <div className="p-4">
              <ul className="list-disc">
                <li className="mb-2 md:text-lg">
                  Worked with backend developers to create APIs
                </li>
                <li className="mb-2 md:text-lg">
                  Actively developed and maintain user-friendly and interactive
                  UI
                </li>
                <li className="mb-2 md:text-lg">
                  Consistently developed and deployed code to the organization's
                  GitHub repository
                </li>
              </ul>
            </div>
        ...
        <div className="bg-blue-100 mt-5 mb-5 border-slate-900 rounded-lg p-3 lg:w-3/4">
          ...
          <div>
            ...
            <div className="p-4">
              <ul className="list-disc">
                <li className="mb-2 md:text-lg">
                  Actively write scalable, reusable, and effective typescript
                  code
                </li>
                <li className="mb-2 md:text-lg">
                  Actively debug code to improve performance
                </li>
                <li className="mb-2 md:text-lg">
                  Consistently developed and deployed code to the organization's
                  GitHub repository
